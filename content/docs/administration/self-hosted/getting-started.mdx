...
This page is the short version: what you need, and the fastest path to a running forum. For the full walkthrough, see [Installation](/docs/administration/self-hosted/installation).
...
- [Installation](/docs/administration/self-hosted/installation): the full walkthrough, with troubleshooting
- [Configuration](/docs/administration/self-hosted/configuration): every environment variable explained
