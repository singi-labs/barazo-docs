...
Barazo is configured through environment variables in your `.env` file. This page lists them by area. The ones you must set to get a forum running are covered in [Installation](/docs/administration/self-hosted/installation). This page is the full reference.
...
- [Installation](/docs/administration/self-hosted/installation): the setup walkthrough
- [Getting started](/docs/administration/self-hosted/getting-started): requirements and the quick path
