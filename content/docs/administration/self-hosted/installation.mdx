...
This is the full walkthrough for deploying a Barazo forum. For the short version, see [Getting started](/docs/administration/self-hosted/getting-started).
...
Every variable, with defaults, is in the [Configuration reference](/docs/administration/self-hosted/configuration).
...
- [Configuration](/docs/administration/self-hosted/configuration): the full environment reference
